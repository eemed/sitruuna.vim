...
call s:HL('SpellBad'    , 'red'    , 'none'   , 'bold')
call s:HL('SpellCap'    , 'red'    , 'none'   , 'bold')
call s:HL('SpellLocal'  , 'orange' , 'none'   , 'bold')
call s:HL('SpellRare'   , 'orange' , 'none'   , 'bold')
